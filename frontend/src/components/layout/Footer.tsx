...
export function Footer() {
  return (
    <footer className="bg-slate-50 dark:bg-slate-900/50 pt-12 pb-8">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <h3 className="text-xl font-bold mb-4">Spendify</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/transactions" className="text-muted-foreground hover:text-foreground transition-colors">Transactions</Link></li>
